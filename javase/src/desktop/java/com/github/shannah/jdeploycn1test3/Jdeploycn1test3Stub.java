...
package com.github.shannah.jdeploycn1test3;
 ...
 * @author Shai Almog
 */
public class Jdeploycn1test3Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Jdeploy Cn1test 3";
    private static final String APP_NAME = "jdeploy-cn1test-3";
    ...
    private Jdeploycn1test3 mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Jdeploycn1test3Stub());
    }
